...
const CO_ORGANIZERS = [
  ...
  },
  {
    ...
    intro:
      "中原大學 開源軟體開發社 × GDG on Campus CYCU 是一個由 Google 官方支持的學生開發者社群，致力於推廣資訊技術、軟體開發與 AI 等前沿領域，提供社課、工作坊、實作專案與技術交流平台，讓中原學生從零開始學習程式、AI、資安等技能，並與志同道合的夥伴一起成長與合作。",
  ...
  },
  {
    ...
    logo: "img/co-organizer/國立高雄科技大學.png",
    intro:
      "GDG on Campus NKUST 致力於在高科大五大校區（建工、燕巢、第一、楠梓、旗津）推廣 Google 資源。\n我們透過不定期舉辦的技術工作坊與活動，建立一個跨校區的學習社群，協助同學們掌握最新的開發工具與技術趨勢，共同成長並連結全球開發者網路。",
    link: "https://gdg.community.dev/gdg-on-campus-national-kaohsiung-university-of-science-and-technology-kaohsiung-taiwan/",
  },
];
  ...
  zh: {
    translation: {
      ...
      contact: {
        ...
        importantLabel: "重要提醒：",
        note1: "• 請於 AI CUP 報名系統 (https://go.aicup.tw/) 完成報名登錄",
  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        date: "2026.03.05 ~ 2026.07.23",
        brochureLink: "Bilingual Brochure",
      },
      about: {
