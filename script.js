    ...
    translation: {
      ...
      news: {
        ...
        items: [
          ...
          { date: "2026.06.24", title: "關於「書面報告書」以及「實作程式碼」之相關說明如下：<br><br>1. 僅私有版排行榜（Private Leaderboard）前 30 名參賽隊伍需要繳交「書面報告書」以及「實作程式碼」，且倘若超過期限上傳檔案，將被取消獲獎資格，不容異議，其餘隊伍則不在此限。<br><br>2. 由於目前尚未完成相關資料彙整，因此檔案上傳之說明信件，將於明日中午 12:00 前寄出，統一公告檔案上傳平臺網址與帳密，以及檔案撰寫說明。<br><br>感謝大家的耐心等候，不便之處，敬請見諒。" },
